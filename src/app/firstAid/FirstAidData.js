export default {
  ...
  chemicalPoisoning_swallowing: [
    {
      body:
        'يراقب التنفس مع عمل تنفس صناعي إذا لزم الأمر، وذلك بإمالة الرأس المصاب الي الخلف وذلك لتفتيح المسالك الهوائية مع إغلاق فوهتي الأنف بالأصبع واخذ شهيق عميق ووضع شفتي المعالج بإحكام فوق فم المصاب ونفخ الهواء في رئتيه, وذلك مع مراقبة صدر المريض الذي يرتفع عندما يصل الهواء الي داخل الرئتين.'
      // image: require('')
    },
    {
  ...
  chemicalPoisoning_inhaling: [
    ...
    {
      body:
        'إجراء تنفس صناعي في حالة هبوط أو فشل التنفس وذلك بإمالة الرأس المصاب الي الخلف وذلك لتفتيح المسالك الهوائية مع إغلاق فوهتي الأنف بالأصبع واخذ شهيق عميق ووضع شفتي المعالج بإحكام فوق فم المصاب ونفخ الهواء في رئتيه, وذلك مع مراقبة صدر المريض الذي يرتفع عندما يصل الهواء الي داخل الرئتين.'
      // image: require('')
    },
    {
      body:
