export default ar = {
  ...
  UnAuthorized:
    'انتهت جلسة تسجيل الدخول الخاصة بك. اضفط علي "حسنًا" حتي تسجل الدخول مجددًا',
  ...
  AuthFailed: 'فشل تسجيل الدخول, البيانات غير صحيحة',
  ...
  LocationAlert:
    'حتى يكون بإمكانك الوصول للمساعدة على الفور، اسمح للتطبيق بالوصول لموقعك، انقر على الإعدادات > الخصوصية > الموقع > دائمًا > عد إلى التطبيق > انقر على إعادة التحميل',
  LocationAlert_:
    'حتى يكون بإمكانك الوصول للمساعدة على الفور، اسمح للتطبيق بالوصول لموقعك، انقر على الإعدادات > الموقع > دائمًا > عد إلى التطبيق > انقر على إعادة التحميل',
  SettignsError: 'فشل الوصول للإعدادات',
  Error: 'خطأ ',
  ...
  Burns: 'الحروق',
  ChemicalPoisoning: 'التسمم الكيميائي',
  CPR: 'الإنعاش القلبي الرئوي',
  Seizure: 'التشنجات',
  Cuts: 'الجروح',
  EyeInjury: 'إصابات العين',
  Fractures: 'الكسور',
  HeadInjury: 'إصابات الرأس',
  Nosebleed: 'الرعاف',
  ToothInjury: 'إصابات الأسنان',
  EyeInjury_Puncture: 'قطع/ثقب العين',
  EyeInjury_Scratch: 'خدوش العين',
  ...
  OK: 'حسنا',
  ShortName: 'الاسم قصير للغاية يجب ان يكون ثلاث حروف على الاقل',
  SpecialName: 'الاسم لا يجب ان يحتوي على حروف مميزة',
  ConfirmPasswordError: 'تأكيد كلمة المرور لا تتوافق مع كلمة المرور',
  AgeError: 'يجب ان يكون سنك اكبر من ثلاث عشر عاما كي تستخدم هذا التطبيق',
  PhoneNotValid: 'رقم الهاتف غير صحيح',
  VSecure: 'قوي جدا جدا جدا',
  Secure: 'قوي جدا جدا',
  VStrong: 'قوي جدا',
  Strong: 'قوي',
  Average: 'متوسط',
